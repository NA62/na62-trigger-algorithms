...
//		(OPTION_L1_TRIG_MASK, po::value<std::string>()->required(),
//				"Set L1 trigger mask for L0 trigger mask")
//		(OPTION_L1_TRIG_LOGIC, po::value<std::string>()->required(),
//				"Set L1 trigger logic for L0 trigger mask")
//		(OPTION_L1_TRIG_FLAG, po::value<std::string>()->required(),
//				"Set L1 trigger flag for L0 trigger mask")
//		(OPTION_L1_TRIG_DS, po::value<std::string>()->required(),
